...
/* The letters end at 126; 128..155 are the TILE glyphs - our own shapes,
 * generated by tools/font_tiles.py. 127 is a hole and is emitted blank so the
 * indexing stays a straight subtraction. */
#define FONT_LAST  155
