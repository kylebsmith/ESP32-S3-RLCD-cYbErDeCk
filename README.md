...
3 printed parts + a cover · 8 screws · 8 magnets · 113 automated checks
```
...
python3 tools/validate.py          # 113 checks; non-zero exit if any fail
```
...
| | |
|---|---|
| **[DATUMS.md](docs/DATUMS.md)** | every dimension, its provenance, thirty-eight recorded corrections, nine open items |
...
| `tools/validate.py` | 117-check design audit — the build gate |
...
tools/
  ...
  validate.py           117-check design audit — the build gate
